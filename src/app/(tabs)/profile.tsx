              ...
              <View className="flex-row items-center justify-between py-3 border-b border-white/5">
                <View className="flex-row items-center flex-1">
                  ...
                  <View className="ml-3 flex-1">
                    ...
                    <Text className="text-af-silver text-xs">Requires a native iPhone app</Text>
                  </View>
                </View>
                <View className="bg-white/10 px-3 py-1 rounded-full">
                  <Text className="text-af-silver text-xs">Web unavailable</Text>
                </View>
              </View>
              ...
              <View className="flex-row items-center justify-between py-3">
                <View className="flex-row items-center flex-1">
                  ...
                  <View className="ml-3 flex-1">
                    ...
                    <Text className="text-af-silver text-xs">Planned for later</Text>
                  </View>
                </View>
                <View className="bg-white/10 px-3 py-1 rounded-full">
                  <Text className="text-af-silver text-xs">Coming later</Text>
                </View>
              </View>
            </View>
